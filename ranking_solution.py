...
class ROBUST04Retriever:
    ...
    def __init__(self, queries_path: str = "files/queriesROBUST.txt", qrels_path: str = "files/qrels_50_Queries.txt", output_dir: str = "./output"):
        """
    ...
    def run_neural_reranking(self, model_name: str = 'cross-encoder/ms-marco-MiniLM-L-12-v2',
        ...
        cross_encoder = CrossEncoder(model_name, max_length=512, device=self.device)
        print("Model loaded!")
